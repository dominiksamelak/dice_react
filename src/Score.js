...
export default function Score(props) {
  ...
  const handlePickButtonClick = (scoreType) => {
    ...
    const calculateWorldScoresSum = () => {
      let sum = Object.keys(selectedWorldScores[player]).reduce((partialSum, scoreType) => {
        const score = scores[`${player}Scores`][scoreType];
        if (!isNaN(score) && score !== null && selectedWorldScores[player][scoreType]) {
      ...
      <div key={player}>
        ...
        <div className='world-scores'>
          ...
          <button
              ...
              disabled={currentPlayer !== (player.slice(-1) === 'o' ? 2 : 1) || pickedSchoolScores[player] < 3}
            >
              X
          </button>
          {selectedWorldScores[player].onePair && <span className="checkmark">&#10003;</span>}
          ...
          <p>2P: {scores[`${player}Scores`].twoPairs}</p>
            ...
            >
              ...
              {selectedWorldScores[player].twoPairs && <span className="checkmark">&#10003;</span>}
          ...
          <p>T: {scores[`${player}Scores`].triple}</p>
            ...
            >
              ...
              {selectedWorldScores[player].triple && <span className="checkmark">&#10003;</span>}
            ...
            >
              ...
              {selectedWorldScores[player].straightFlush && <span className="checkmark">&#10003;</span>}
            ...
            >
              ...
              {selectedWorldScores[player].royalFlush && <span className="checkmark">&#10003;</span>}  
            ...
            >
              ...
              {selectedWorldScores[player].fullHouse && <span className="checkmark">&#10003;</span>}
            ...
            >
              ...
              {selectedWorldScores[player].quads && <span className="checkmark">&#10003;</span>}
            ...
            >
              ...
              {selectedWorldScores[player].poker && <span className="checkmark">&#10003;</span>}
            </div>
